...
\begin{itemize}
\item \textbf{Flooding:} Packets forwarded on all interfaces - this confirms that the pnet and the skeleton framework work as expected.
...
\item 11212: Tests IPv6 hop\_limit, sends 4 packets \hyperref[fig::test_success]{Figure }\ref{fig::test_network}.
\item 1211: Test ICMPv6 checksum, sends two packets
\item 1212: T
\item 1213
\item 1214
\item 1215
