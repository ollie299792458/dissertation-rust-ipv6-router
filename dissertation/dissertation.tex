...
There could be security exploits in my code, and if anybody would like to adapt my code for use in a router I would recommend it is tested afresh. (My router and test bench code is released under the GPL\cite{gpl} on Github\cite{repo}).
...
Rust multithreading with IPnet and communication and locking
